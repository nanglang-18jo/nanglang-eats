...
public class ReviewController {
	...
	public ResponseEntity<ReviewResponse> createReview(@RequestBody ReviewRequest request, @AuthenticationPrincipal CustomAuthenticationProvider customAuthenticationProvider) {
		ReviewResponse response = reviewService.createReview(request, customAuthenticationProvider.getUser());
